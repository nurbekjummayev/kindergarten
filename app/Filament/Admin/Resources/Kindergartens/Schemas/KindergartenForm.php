    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->schema([
                ...
                Select::make('status')
                    ->label('Holat')
                    ->enum(KindergartenStatus::class)
                    ->options(KindergartenStatus::class)
                    ->default(KindergartenStatus::DRAFT)
                    ->required(),
                ...
                Textarea::make('rejection_reason')
                    ...
                    ->rows(3)
                    ->columnSpanFull()
                    ->visible(fn ($get) => $get('status') === KindergartenStatus::REJECTED->value),
